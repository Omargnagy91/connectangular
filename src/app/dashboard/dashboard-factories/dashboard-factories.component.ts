    ...
    const dialogRef= this.dialog.open(ConfirmationComponent,{
     ...
     const subscribeDialog = dialogRef.componentInstance.confirmed.subscribe((data) => {
      ...
      if (data) {
        ...
        this.dataSource = new MatTableDataSource<PeriodicElement>(ELEMENT_DATA);
        this.dataSource.paginator = this.paginator;
        this._snackBar.open('تمت حذف الصناعة بنجاح','إغلاق' ,{
          duration:  5000,
          horizontalPosition: this.horizontalPosition,
          verticalPosition: this.verticalPosition
        });
...
const ELEMENT_DATA: PeriodicElement[] = [
  {select:false,position: 1, name: 'عنوان الصناعة', weight: 1.0079, symbol: '4/12/2022'},
  {select:false, position: 2, name: 'عنوان الصناعة', weight: 4.0026, symbol: '4/12/2022'},
  {select:false, position: 3, name: 'عنوان الصناعة', weight: 6.941, symbol: '4/12/2022'},
  {select:false, position: 4, name: 'عنوان الصناعة', weight: 9.0122, symbol: '4/12/2022'},
  {select:false, position: 5, name: 'عنوان الصناعة', weight: 10.811, symbol: '4/12/2022'},
  {select:false, position: 6, name: 'عنوان الصناعة', weight: 12.0107, symbol: '4/12/2022'},
  {select:false, position: 7, name: 'عنوان الصناعة', weight: 14.0067, symbol: '4/12/2022'},
  {select:false, position: 8, name: 'عنوان الصناعة', weight: 15.9994, symbol: '4/12/2022'},
  {select:false, position: 9, name: 'عنوان الصناعة', weight: 18.9984, symbol: '4/12/2022'},
  {select:false, position: 10, name: 'عنوان الصناعة', weight: 20.1797, symbol: '4/12/2022'},
];
